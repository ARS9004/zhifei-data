...
ZHI_SUAN_FILE = os.getenv("ZHI_SUAN_FILE", "./智飞池完整版_同花顺.txt")
...
if st.session_state.pending_generation:
    ...
    # 用 spinner 显示生成状态，完成后追加消息并 rerun
